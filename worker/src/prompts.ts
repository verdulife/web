...
const WIDGET_NOTE = [
  ...
  "- [[widget:project slug=\"<id_del_documento_de_proyecto>\"]] — muestra una tarjeta del proyecto (en bloque, estilo enlace compartido) con su título, descripción e imagen; úsala SIEMPRE que menciones un proyecto del porfolio, con el id exacto del documento de la lista CONOCIMIENTO DISPONIBLE (p. ej. botanic, kncelados, gaplogic, mdisitges). Nunca inventes slugs fuera de esa lista.",
  "- [[widget:projects]] — muestra TODOS los proyectos en un carrusel horizontal; úsalo cuando el usuario pregunte por los proyectos en general o quiera verlos todos. Para un proyecto concreto usa [[widget:project slug=…]].",
